...
<head>
    ...
    <style>
        ...
        .status-badge.contacted { background: #f0fdf4; color: #166534; }
        .status-badge.converted { background: #eff6ff; color: #1d4ed8; }
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="bookings.php" class="sidebar-link <?= $active_page === 'bookings.php' ? 'active' : '' ?>">
                    ...
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"></path></svg>
                    Manage Bookings
                </a>
            </li>
            <li>
                <a href="rooms.php" class="sidebar-link <?= $active_page === 'rooms.php' ? 'active' : '' ?>">
                    <!-- Bed Icon -->
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                    Manage Rooms
                </a>
            </li>
            ...
            <li>
                <a href="coupons.php" class="sidebar-link <?= $active_page === 'coupons.php' ? 'active' : '' ?>">
                    <!-- Tag/Percentage Icon -->
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M7 7h.01M6 20h12a2 2 0 002-2V8a2 2 0 00-2-2H6a2 2 0 00-2 2v10a2 2 0 002 2zM9 16h6m-6-4h6"></path></svg>
                    Manage Coupons
                </a>
            </li>
            <li>
                <a href="enquiries.php" class="sidebar-link <?= $active_page === 'enquiries.php' ? 'active' : '' ?>">
                    ...
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0a2 2 0 01-2 2H6a2 2 0 01-2-2m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg>
                    Enquiries Log
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="home-settings.php" class="sidebar-link <?= $active_page === 'home-settings.php' ? 'active' : '' ?>">
                    ...
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path></svg>
                    Home Page Editor
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="logout.php" class="sidebar-link">
                    <!-- Log out Icon -->
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
                    Log Out
                </a>
            </li>
        </ul>
