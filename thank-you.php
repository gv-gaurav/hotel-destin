                ...
                <div class="confirmation-card wow fadeInUp">
                    ...
                    <div class="booking-details-box">
                        ...
                        <div class="details-grid">
                            ...
                            <div class="detail-item-col">
                                <label><?= strtolower($booking['payment_status']) === 'paid' ? 'Total Cost Paid (GST Incl.)' : 'Total Cost (Payable at Hotel)' ?></label>
                                <span class="price-highlight">₹<?= number_format($booking['total_amount'], 2) ?></span>
                            </div>
                            <div class="detail-item-col">
                                <label>Payment Option</label>
                                <span><?= htmlspecialchars($booking['payment_method'] ?: 'Razorpay') ?> (<?= ucfirst(htmlspecialchars($booking['payment_status'])) ?>)</span>
                            </div>
                        </div>
                    </div>
