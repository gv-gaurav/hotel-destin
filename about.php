...
<head>
    ...
    <style>
        ...
        /* Image-less Restaurant & Banquet Section Styles */
        ...
        .service-box-card:hover {
            ...
            border-color: rgba(161, 122, 66, 0.3);
        }
        ...
        .service-card-icon {
            ...
            height: 60px;
            border-radius: 16px;
            background-color: rgba(161, 122, 66, 0.08);
            color: #a17a42;
            display: flex;
            align-items: center;
            justify-content: center;
            ...
            margin-bottom: 25px;
            transition: all 0.3s ease;
            border: 1px solid rgba(161, 122, 66, 0.1);
        }

        .service-box-card:hover .service-card-icon {
...
<body>
    ...
    <main class="main">
        ...
        <section class="about-banner wow fadeIn">
            <div class="container">
                <ul class="breadcrumbs mb-15 justify-content-center" style="padding: 0; background: transparent; display: flex;">
                    <li><a href="index.php" style="color: rgba(255,255,255,0.8);">Home</a><span class="arrow-right" style="color: rgba(255,255,255,0.5);"><svg width="7" height="12" viewBox="0 0 7 12" fill="none">
        ...
        <!-- Dining & Events Section (Restaurant & Banquet) -->
        <section class="dining-events-section section-box py-tight">
            <div class="container">
                <div class="text-center mb-50 wow fadeInUp">
                    <h2 class="neutral-1000 font-heading" style="font-size: 30px; font-weight: 500;">Dining & Celebrations</h2>
                    <p class="text-md neutral-500 max-width-600 mx-auto mt-10">
                        From fine rooftop dining to hosting elegant social events, discover the premium lifestyle venues at Hotel Destin.
                    </p>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="service-box-card wow fadeInUp">
                            <div>
                                ...
                                <ul class="service-bullet-list">
                                    <li class="service-bullet-item">
                                        ...
                                        Operating Hours: 07:00 AM to 11:30 PM Daily
                                    </li>
                                    <li class="service-bullet-item">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                            <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />
                                        </svg>
                                        Gourmet veg & non-veg menus crafted by master chefs
                                    </li>
                                    <li class="service-bullet-item">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                            ...
                            <div>
                                <a class="btn btn-black-lg w-100 text-center" href="restaurant.php" style="border-radius: 8px; font-weight: 700; padding: 12px 24px; text-decoration: none;">Explore Restaurant & Menu ➔</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Column 2: Banquet -->
                    <div class="col-lg-6 col-12">
                        <div class="service-box-card wow fadeInUp" data-wow-delay="0.1s">
                            <div>
                                <div class="service-card-icon">
                                    <!-- Celebrations / Venue Icon -->
                                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                                    </svg>
                                </div>
                                <span class="service-tag">Premium Event Venue</span>
                                <h3 class="service-heading">Banquet Oh Saathi Re</h3>
                                <p class="service-subtitle">Where Memorable Celebrations Come to Life</p>
                                <p class="service-desc">
                                    Host your dream weddings, grand receptions, birthdays, or corporate conferences in Gwalior's premier pillar-free venue. Banquet Oh Saathi Re spans over 3,800 square feet and accommodates up to 300 guests. With exquisite custom decor options, state-of-the-art audiovisual setups, and professional catering services, we ensure your special events are executed to perfection.
                                </p>
                                <ul class="service-bullet-list">
                                    <li class="service-bullet-item">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                        ...
                                        Large capacity: Comfortably accommodates up to 300 guests
                                    </li>
                                    <li class="service-bullet-item">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                        ...
                                        Spacious layout: 3,800 Sq. Ft. pillar-less hall with high ceilings
                                    </li>
                                    <li class="service-bullet-item">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                        ...
                                        Exquisite catering & professional planning support
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <a class="btn btn-black-lg w-100 text-center" href="banquet.php" style="border-radius: 8px; font-weight: 700; padding: 12px 24px; text-decoration: none;">Book Event Venue ➔</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="amenity-category-box wow fadeInUp">
                            ...
                            <ul class="amenity-list">
                                ...
                                <li class="amenity-item">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M2 22h20M4 22V11a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v11M12 9V5a2 2 0 0 0-2-2H8" />
                                    </svg>
                                    lounge
                                </li>
                                <li class="amenity-item">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="amenity-category-box wow fadeInUp" data-wow-delay="0.05s">
                            ...
                            <ul class="amenity-list">
                                <li class="amenity-item">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M5 12.55a11 11 0 0 1 14.08 0M1.42 9a16 16 0 0 1 21.16 0M8.58 16.14a7 7 0 0 1 10.84 0M12 20h.01" />
                                    </svg>
                                    free wi-fi
                                </li>
                                <li class="amenity-item">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="amenity-category-box wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <ul class="amenity-list">
                                ...
                                <li class="amenity-item">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M18 10h-6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2z" />
                                        <path d="M14 6a3 3 0 0 1-3-3M6 18H2" />
                                    </svg>
                                    smoking rooms
                                </li>
                            ...
                            <ul class="amenity-list">
                                ...
                                <li class="amenity-item">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        ...
                                        <path d="M12 2v9M7 11V7a5 5 0 0 1 10 0v4" />
                                    </svg>
                                    security guard
                                </li>
                                <li class="amenity-item">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="amenity-category-box wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <ul class="amenity-list">
                                ...
                                <li class="amenity-item">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 1 13v3c0 .6.4 1 1 1h2m10 0h4m-12 0a3 3 0 1 1 6 0m6 0a3 3 0 1 1 6 0" />
                                    </svg>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="amenity-category-box wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <ul class="amenity-list">
                                ...
                                <li class="amenity-item">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M4 22V4c0-.5.2-1 .6-1.4C5 2.2 5.5 2 6 2h8l6 6v14M14 2v6h6M16 13H8M16 17H8M10 9H8" />
                                    </svg>
                                    photocopying
                                </li>
                            </ul>
