        ...
        <div class="main-header">
          ...
          <div class="header-right d-flex align-items-center">
            <div class="align-middle mr-15">
              ...
              ?>
              <a class="btn-whatsapp-header" href="https://wa.me/<?= htmlspecialchars($wa_url) ?>?text=<?= urlencode('Hello, I would like to enquire about room availability and booking at Hotel Destin.') ?>" target="_blank">
            ...
            <div class="d-none d-xxl-inline-block align-middle mr-15"><button class="btn btn-default" onclick="openEnquiryModal()" style="border: none;">Enquire Now</button></div>
    ...
    <div class="enquiry-modal-overlay" id="enquiryModalOverlay" style="display: none;">
      <div class="enquiry-modal-card">
        ...
        <h3 class="enquiry-modal-title">Enquire Now</h3>
